...
class AnimatedSplash(QWidget):
    ...
    def __init__(self, version: str = '0.1.0'):
        ...
        self._logo.setStyleSheet('font-size: 48px; color: #58a6ff; background: transparent;')
        layout.addWidget(self._logo)

        # App name
        self._name = QLabel('Agent Notify')
        self._name.setAlignment(Qt.AlignCenter)
        self._name.setStyleSheet('color: #e6edf3; font-size: 20px; font-weight: 700; background: transparent;')
        layout.addWidget(self._name)

        # Version
        self._ver = QLabel(f'v{version}')
        self._ver.setAlignment(Qt.AlignCenter)
        self._ver.setStyleSheet('color: #8b949e; font-size: 12px; background: transparent;')
